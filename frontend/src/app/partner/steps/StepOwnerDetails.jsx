        ...
        <div className="relative group h-32 w-full rounded-xl bg-gray-50 border border-gray-200 overflow-hidden shadow-sm">
          ...
          <div className="absolute inset-0 bg-black/25 flex items-center justify-center gap-3 transition-opacity">
            <button
              ...
              className="p-2.5 bg-white/90 rounded-full text-[#005CA8] hover:bg-white transition-colors shadow-lg backdrop-blur-sm"
              title="View Image"
              type="button"
            >
              <Eye size={20} />
        ...
        <div className="space-y-2">
          ...
          {isFlutter && (
            <button
              ...
              disabled={uploading}
              className="w-full border-2 border-dashed rounded-xl p-4 flex flex-col items-center justify-center gap-2 transition-colors border-[#005CA8] bg-[#005CA8]/5 hover:bg-[#005CA8]/10 disabled:opacity-50"
            >
              {uploading ? (
                <Loader2 size={24} className="text-[#005CA8] animate-spin" />
              ) : (
                <div className="w-10 h-10 rounded-full bg-[#005CA8] flex items-center justify-center shadow-sm text-white">
                  <Camera size={20} />
                </div>
              )}
              <div className="text-center">
                <p className="text-xs font-bold text-[#005CA8]">
          ...
          <div className="relative">
            ...
            <div className={`
               ...
               ${error ? 'border-red-300 bg-red-50' : 'border-gray-300 hover:border-[#005CA8] hover:bg-[#005CA8]/5 bg-gray-50'}
            `}>
              {uploading ? (
                <Loader2 size={24} className="text-[#005CA8] animate-spin" />
              ) : (
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div>
        ...
        <input
          className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#005CA8]"
      ...
      <div className="space-y-4 pt-2 border-t border-gray-100">
        <h3 className="text-sm font-black text-slate-900">Aadhaar Verification</h3>

        <div>
          <label className="block text-xs font-bold text-gray-500 mb-1">Aadhaar Number</label>
          <input
            className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#005CA8] tracking-widest font-mono"
      ...
      {/* PAN Section */}
      <div className="space-y-4 pt-2 border-t border-gray-100">
        <h3 className="text-sm font-black text-slate-900">PAN Verification</h3>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-bold text-gray-500 mb-1">PAN Number</label>
            <input
              className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm uppercase focus:outline-none focus:ring-2 focus:ring-[#005CA8] font-mono"
      ...
      <div className="space-y-3 pt-2 border-t border-gray-100">
        <h3 className="text-sm font-black text-slate-900">Owner Address</h3>

        <input
          className="w-full border border-gray-200 rounded-xl px-3 py-2 text-sm mb-2 focus:outline-none focus:ring-2 focus:ring-[#005CA8]"
        ...
        <div className="grid grid-cols-2 gap-3">
          <input
            className="border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#005CA8]"
            placeholder="City"
            onFocus={handleFocus}
